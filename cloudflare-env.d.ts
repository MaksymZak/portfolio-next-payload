/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 1fd0f9be7faa90646305b621772df682)
...
interface __BaseEnv_CloudflareEnv {
	...
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* portfolio-next-payload */;
}
