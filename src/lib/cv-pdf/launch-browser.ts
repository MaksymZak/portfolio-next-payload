...
/**
 * Local-machine only. Production serves pre-generated PDFs from R2
 * (NEXT_PUBLIC_CV_URL_EN / NEXT_PUBLIC_CV_URL_UK); /api/cv is disabled on
 * Vercel so headless Chromium never enters the deployment.
 */
