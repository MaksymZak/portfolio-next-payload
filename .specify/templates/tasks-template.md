...
- Keep tasks small enough to verify and review without guessing hidden work
...
- [ ] T004 Capture release-scope guardrails and validation checkpoints from plan.md
...
- [ ] T018 [US1] Record release-plan status update for the delivered US1 slice
...
- [ ] T025 [US2] Record release-plan status update for the delivered US2 slice
...
- [ ] T031 [US3] Record release-plan status update for the delivered US3 slice
...
- [ ] TXXX Public-safety and honesty review for shipped vs coming-next content
- [ ] TXXX EN/UK parity validation for touched MVP surfaces
- [ ] TXXX Clean Editorial Technical design-contract review against DESIGN.md
- [ ] TXXX Run quickstart.md validation
- [ ] TXXX Final release-plan sync for implemented and deferred scope
...
- Story validation and release-plan update before moving to next priority
...
5. Update release plan to reflect the new implemented status
6. Deploy/demo if ready

### Incremental Delivery

1. Complete Setup + Foundational → Foundation ready
2. Add User Story 1 → Test independently → Update release plan → Deploy/Demo (MVP!)
3. Add User Story 2 → Test independently → Update release plan → Deploy/Demo
4. Add User Story 3 → Test independently → Update release plan → Deploy/Demo
...
- Each user story should preserve public-safety rules and built-vs-next honesty
- Each completed slice should leave explicit status updates in the release plan
